...
PRODUCT_COPY_FILES += \
	...
	$(LOCAL_PATH)/configs/media/media_codecs_vendor_audio.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_audio.xml \
...
PRODUCT_COPY_FILES += \
	...
	$(LOCAL_PATH)/configs/sensors/sensor_def_qcomdev_drg.conf:$(TARGET_COPY_OUT_VENDOR)/etc/sensors/sensor_def_qcomdev_drg.conf \
